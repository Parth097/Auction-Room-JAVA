...
public class PSItemLot implements Entry {
    ...
    // Arg constructor
    public PSItemLot(int lotID, String lotName, String lotSeller, String lotDescription, Double lotBuyNow, ArrayList<Integer> lotBid, Boolean purchased, Boolean deleted, String buyer) {
        itemID = lotID;
        itemName = lotName;
